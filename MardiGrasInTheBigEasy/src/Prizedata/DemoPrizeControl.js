...
DemoPrizeControl =function(mainNode)
{
    ...
    this.addReelStop("Jester Wheel", "Showcase", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "Random", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "Random+PYP", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "Random+FSP", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "Wheel+FSP", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "Wheel+PYP", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "MaxSpins", "yellow", [10,2,15,15,15]);
    this.addReelStop("Jester Wheel", "Anticipation", "yellow", [10,2,15,13,45]);
    this.addReelStop("Jester Wheel", "Anticipation+FSP", "yellow", [5,5,15,13,45]);
...
/*    aFreeSpinScenarios = this.setupMaxRetriggerFreeSpinsWilds();*/
    ...
    this.addReelStop("Themes", "Girl", "blue",  [19,42,44,42,42]);
